...
public class AccesHTTP extends AsyncTask<String, Integer, Long> {
    ...
    // propriétés
    public String retourServeur=""; // information retournée par le serveur
    ...
    protected void onPostExecute(Long result) {
        // retourServeur contient l'information récupérée
        delegate.processFinish(this.retourServeur.toString());
    }
}
